...
## Helpers not needed for vote verification project
...
#   if channel == "VOICE"
#     full_address << "<say-as interpret-as='vxml:digits'>#{item[:input_code]}</say-as>" unless item[:input_code].nil?
#   else
#     full_address << item[:input_code] unless item[:input_code].nil?
#   end
